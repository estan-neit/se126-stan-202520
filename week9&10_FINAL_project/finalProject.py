...
# Display the menu
menu()
# Ask the user if they are ready to place their order
ans = input("Would you like to place an order? [ y / n ]").lower()

# Check if the user wants to enter the search program and check for invalid entries
while ans != "y" and ans != "n":
    print("Sorry, but we could not understand your response. Please try again.")
    ans = input("Would you like to place an order? [ y / n ]").lower()

# Online menu
while ans == "y":
    # ans: user's choice to start search system
    print(f"\tHere are your search options:")
    print("==========================================")
    ...
    if searchType == "1":
        ...
        if not found:
            ...
            # Appetizer FOUND!
            print(f"Your search for {searchApp} was FOUND! Here is more about the appetizer: ")
            for index in found:
        ...
        if not found:
            ...
            # Entree FOUND!
            print(f"Your search for {searchEntree} was FOUND! Here is more about the entree: ")
            for index in found:
        ...
        if not found:
            ...
            # Tandoori FOUND!
            print(f"Your search for {searchTandoori} was FOUND! Here is more about the tandoori dish: ")
            for index in found:
        ...
        if not found:
            ...
            # Rice FOUND!
            print(f"Your search for {searchRice} was FOUND! Here is more about the rice dish: ")
            for index in found:
        ...
        if not found:
            ...
            # Noodles FOUND!
            print(f"Your search for {searchNoodles} was FOUND! Here is more about the noodle dish: ")
            for index in found:
        ...
        if not found:
            ...
            # Dessert FOUND!
            print(f"Your search for {searchDessert} was FOUND! Here is more about the dessert: ")
            for index in found:
        ...
        print("ERROR: Invalid search. Please try again.")
